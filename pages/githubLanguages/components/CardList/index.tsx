    ...
    <section>
      <section className={ styles.wrapper }>
        <section>
          ...
          <h4 className={styles.linkWrapper}>
            <span>{ t.devicons }:&nbsp;</span>
          ...
          <h4 className={styles.linkWrapper}>
            <span>{ t.projectRepos }:&nbsp;</span>
            <Link href="https://github.com/lunatic-fox/lunaticfox">
              <a><i>GitHub&nbsp;</i></a>
            </Link>
            <svg 
              viewBox="0 0 128 128"
